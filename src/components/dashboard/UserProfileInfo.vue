<template>
  <div class="flex flex-col md:flex-row items-center justify-between py-8 px-8 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-2xl shadow-lg border border-blue-100">
    <!-- 左侧：头像+身份信息 -->
    ...
    <div class="flex flex-col items-end space-y-3 min-w-[220px] w-full md:w-auto mt-6 md:mt-0">
