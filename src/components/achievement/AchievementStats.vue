...
const stats = computed(() => [
  {
    label: '总成果数',
    value: props.totalAchievements,
    description: '包含所有类型的成果总数',
    color: 'bg-blue-100 text-blue-800',
    trend: '总览'
  },
  {
    label: '已认证成果',
    value: props.verifiedAchievements,
    description: `认证率 ${Math.round((props.verifiedAchievements / props.totalAchievements) * 100)}%`,
  ...
  {
    label: '科研成果',
    value: props.researchCount,
    description: '论文、专利等科研成果',
